...
INSERT INTO Recipes (RecipeID, Title, Chef, CuisineType, PrepTime, CookTime, Ingredients, Instructions, DifficultyLevel, Rating)
VALUES
  (1, 'Spaghetti Bolognese', 'Jamie Oliver', 'Italian', 15, 30, 'Ground beef, tomatoes, onion, garlic, spaghetti', '1. Heat oil in a pan. 2. Add onion and garlic. 3. Cook ground beef. 4. Add tomatoes. 5. Simmer. 6. Cook spaghetti. 7. Combine sauce and spaghetti. 8. Serve.', 'Intermediate', 4.5),
  (2, 'Chicken Curry', 'Gordon Ramsay', 'Indian', 20, 40, 'Chicken, onion, ginger, garlic, spices', '1. Heat oil in a pan. 2. Add onion, ginger, and garlic. 3. Cook chicken. 4. Add spices. 5. Simmer. 6. Serve with rice.', 'Advanced', 4.8),
  (3, 'Chocolate Chip Cookies', 'Martha Stewart', 'American', 15, 12, 'Flour, butter, sugar, chocolate chips', '1. Cream butter and sugar. 2. Add flour. 3. Mix in chocolate chips. 4. Drop spoonfuls onto baking sheet. 5. Bake at 350°F for 12 minutes.', 'Easy', 4.3),
  (4, 'Tacos', 'Rick Bayless', 'Mexican', 20, 30, 'Ground beef, tortillas, lettuce, tomatoes, cheese', '1. Cook ground beef. 2. Warm tortillas. 3. Assemble tacos with beef, lettuce, tomatoes, and cheese. 4. Serve with salsa and guacamole.', 'Intermediate', 4.2),
  (5, 'Sushi Rolls', 'Nobu Matsuhisa', 'Japanese', 30, 45, 'Sushi rice, nori, fish, vegetables', '1. Cook sushi rice. 2. Prepare fish and vegetables. 3. Lay nori on sushi mat. 4. Spread rice. 5. Add fillings. 6. Roll tightly. 7. Slice and serve.', 'Advanced', 4.9),
  (6, 'Pasta Carbonara', 'Giada De Laurentiis', 'Italian', 10, 20, 'Pasta, pancetta, eggs, Parmesan cheese', '1. Cook pasta. 2. Cook pancetta. 3. Beat eggs and cheese. 4. Toss cooked pasta with pancetta and egg mixture. 5. Serve with extra cheese.', 'Intermediate', 4.6),
  (7, 'Chicken Tikka Masala', 'Aarti Sequeira', 'Indian', 20, 40, 'Chicken, yogurt, spices, tomato sauce', '1. Marinate chicken in yogurt and spices. 2. Grill or broil chicken. 3. Simmer tomato sauce. 4. Add cooked chicken. 5. Serve with rice and naan.', 'Intermediate', 4.4),
  (8, 'Classic Cheeseburger', 'Bobby Flay', 'American', 15, 20, 'Ground beef, buns, cheese, lettuce, tomato, onion', '1. Form ground beef into patties. 2. Grill or pan-fry burgers. 3. Toast buns. 4. Assemble burgers with cheese, lettuce, tomato, and onion. 5. Serve with fries.', 'Easy', 4.1),
  (9, 'Pad Thai', 'Jet Tila', 'Thai', 15, 25, 'Rice noodles, shrimp, tofu, eggs, peanuts', '1. Soak rice noodles. 2. Cook shrimp and tofu. 3. Scramble eggs. 4. Add noodles and sauce. 5. Toss with shrimp, tofu, eggs, and peanuts. 6. Serve with lime wedges.', 'Intermediate', 4.7),
  (10, 'Beef Stroganoff', 'Ina Garten', 'Russian', 15, 30, 'Beef, mushrooms, onion, sour cream', '1. Sear beef. 2. Cook mushrooms and onion. 3. Add beef and sour cream. 4. Simmer. 5. Serve over egg noodles.', 'Intermediate', 4.2),
  (11, 'Miso Soup', 'Masaharu Morimoto', 'Japanese', 10, 15, 'Miso paste, tofu, seaweed, green onions', '1. Bring water to a simmer. 2. Add miso paste and stir. 3. Add tofu, seaweed, and green onions. 4. Simmer for a few minutes. 5. Serve hot.', 'Easy', 4.0),
  (12, 'Chicken Caesar Salad', 'Julia Child', 'American', 15, 10, 'Chicken, romaine lettuce, croutons, Parmesan cheese', '1. Grill or roast chicken. 2. Tear lettuce into bite-sized pieces. 3. Toss lettuce with dressing. 4. Top with chicken, croutons, and Parmesan cheese.', 'Easy', 4.3),
  (13, 'Hummus', 'Yotam Ottolenghi', 'Middle Eastern', 10, 5, 'Chickpeas, tahini, garlic, lemon juice', '1. Blend chickpeas, tahini, garlic, and lemon juice. 2. Add olive oil and water as needed. 3. Serve with pita bread or vegetables.', 'Easy', 4.6),
  (14, 'Pancakes', 'Joy Wilson', 'American', 10, 15, 'Flour, milk, eggs, butter, sugar', '1. Mix dry ingredients. 2. Whisk together milk, eggs, and melted butter. 3. Combine wet and dry ingredients. 4. Cook pancakes on a griddle. 5. Serve with syrup.', 'Easy', 4.2),
  (15, 'Beef Tacos', 'Patricia Jinich', 'Mexican', 20, 30, 'Beef, tortillas, onion, cilantro, salsa', '1. Cook beef. 2. Warm tortillas. 3. Assemble tacos with beef, onion, cilantro, and salsa. 4. Serve with lime wedges.', 'Intermediate', 4.5),
  (16, 'Shrimp Scampi', 'Emeril Lagasse', 'Italian', 15, 20, 'Shrimp, garlic, butter, white wine, lemon juice', '1. Sauté garlic in butter. 2. Add shrimp and cook until pink. 3. Deglaze with white wine and lemon juice. 4. Serve over pasta.', 'Intermediate', 4.3),
  (17, 'Tomato Soup', 'Ina Garten', 'American', 10, 25, 'Tomatoes, onion, garlic, broth, cream', '1. Sauté onion and garlic. 2. Add tomatoes and broth. 3. Simmer. 4. Blend until smooth. 5. Stir in cream. 6. Serve hot with croutons.', 'Easy', 4.0),
  (18, 'Goulash', 'Wolfgang Puck', 'Hungarian', 20, 40, 'Beef, onions, paprika, tomatoes', '1. Sauté onions. 2. Add beef and cook until browned. 3. Stir in paprika and tomatoes. 4. Simmer. 5. Serve with noodles or bread.', 'Intermediate', 4.2),
  (19, 'Chicken Noodle Soup', 'Alton Brown', 'American', 20, 45, 'Chicken, noodles, carrots, celery, onion', '1. Cook chicken in broth. 2. Remove chicken and shred. 3. Add vegetables and noodles. 4. Simmer until tender. 5. Add shredded chicken. 6. Serve hot.', 'Easy', 4.4),
  (20, 'Lemon Bars', 'Sally McKenney', 'American', 15, 30, 'Flour, sugar, butter, eggs, lemon juice', '1. Mix crust ingredients. 2. Press into pan and bake. 3. Whisk together filling ingredients. 4. Pour over crust and bake. 5. Cool and cut into bars.', 'Easy', 4.1);
...
SELECT * FROM Events WHERE EventID=3;

SELECT * FROM Projects WHERE Budget=8000.00;

SELECT * FROM Transactions WHERE Amount=45.50;

SELECT * FROM Vehicles WHERE  Year=2020;

SELECT * FROM Recipes WHERE  Title='Chicken Curry';

SELECT * FROM Messages WHERE  MessageID=5;

SELECT * FROM Payments WHERE  Amount=70.25;

SELECT * FROM Hotels WHERE  ZipCode=54321;

SELECT * FROM Customers WHERE  FirstName='Foster';